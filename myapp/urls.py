...
urlpatterns = [
    ...
    path('v1/financial-news/', FinancialNewsListView.as_view(), name='financial-news-list'),
    path('v1/currency/', FetchCurrencyNewsView.as_view(), name='fetch-currency-news'),
    path('v1/currency-news/', CurrencyNewsListView.as_view(), name='currency-news-list'),
