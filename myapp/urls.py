...
from myapp.Views.graphView import GraphView_lastweek, GraphView_lastmonth, GraphView_last6months, GraphView_lastyear, GraphView_last5years
...
urlpatterns = [
    ...
    path('v1/graph/<str:from_currency>/<str:to_currency>/last-month', GraphView_lastmonth.as_view(), name='last-month-graph_view'),
